    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.dialog_roll_movie)
                ...
                .setNegativeButton(R.string.btn_interested, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        getGTracker().send(MapBuilder
                                .createEvent("ui_action", "touch", "roll_movie_not_NOT_interested", null)
                                .build()
                        );
                    }
                });
