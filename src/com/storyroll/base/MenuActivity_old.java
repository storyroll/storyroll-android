...
import com.storyroll.activity.LaunchActivity;
import com.storyroll.activity.SettingsActivity;
import com.storyroll.util.AppUtility;
import com.storyroll.util.PrefUtility;
import com.androidquery.util.AQUtility;

public abstract class MenuActivity_old extends BaseActivity_old{
    ...
    private Dialog makeDebugDialog(){
        ...
        .setItems(R.array.debug_items, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
            	...
            	switch(which){
            		case 0:          			
            			AQUtility.cleanCacheAsync(MenuActivity_old.this, 0, 0);            			
